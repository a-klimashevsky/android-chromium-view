...
cp -r $BUILD/content/public/android/java/src/* $PROJ/src/

# copy content resources
cp -r $BUILD/content/public/android/java/res/* $PROJ/res/
...
cp -r $BUILD/out/Release/gen/content_java/res_grit/values/* $PROJ/res/values/

# .template files for org.chromium.content generated by chromium build too
cp -r $BUILD/out/Release/gen/templates/org/chromium/content/* $PROJ/src/org/chromium/content/

# need this jar file for some com.google annotation support
cp $BUILD/out/Release/lib.java/guava_javalib.jar $PROJ/libs/
